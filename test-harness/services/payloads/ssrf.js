...
exports.SSRF_PAYLOADS = void 0;
exports.getSSRFPayloads = getSSRFPayloads;
exports.getSSRFPayloadsBySeverity = getSSRFPayloadsBySeverity;
exports.SSRF_PAYLOADS = [
    {
        url: "http://127.0.0.1/",
...
function getSSRFPayloads(target) {
    if (!target) {
        return exports.SSRF_PAYLOADS;
    }
    return exports.SSRF_PAYLOADS.filter(p => p.target === target);
}
function getSSRFPayloadsBySeverity(severity) {
    return exports.SSRF_PAYLOADS.filter(p => p.severity === severity);
}
