...
exports.XXE_PAYLOADS = void 0;
exports.getXXEPayloads = getXXEPayloads;
exports.XXE_PAYLOADS = [
    {
...
function getXXEPayloads(attackType) {
    if (!attackType) {
        return exports.XXE_PAYLOADS;
    }
    return exports.XXE_PAYLOADS.filter(p => p.attackType === attackType);
}
