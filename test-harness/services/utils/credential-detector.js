...
exports.detectCredentialsInJSON = detectCredentialsInJSON;
exports.containsExposedCredentials = containsExposedCredentials;
...
function detectCredentialsInJSON(json) {
    const jsonString = JSON.stringify(json, null, 2);
    return detectCredentials(jsonString);
}
function containsExposedCredentials(content) {
