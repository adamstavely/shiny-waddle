import { IsString, IsOptional, IsArray, IsNumber, IsBoolean, IsUrl, Min, IsEnum } from 'class-validator';
import { SalesforceExperienceCloudTestType } from '../entities/salesforce-experience-cloud.entity';
