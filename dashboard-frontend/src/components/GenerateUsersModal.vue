          ...
          <div class="modal-body">
            <form @submit.prevent="generate" class="generate-form">
              ...
              <div class="form-group">
                ...
                <input v-model.number="form.count" type="number" min="1" max="100" required />
              </div>
              <div class="form-group">
              ...
              <div class="form-actions">
                ...
                <button type="submit" class="btn-primary">Generate Users</button>
              </div>
            </form>
          </div>
        </div>
