        ...
        <div class="modal-content" @click.stop>
          ...
          <div class="modal-body">
            <form @submit.prevent="save" class="harness-form">
              ...
              <div class="form-group">
                <label>Domain *</label>
                <select v-model="form.domain" required class="form-select">
                  <option value="">Select a domain...</option>
                  <option value="api_security">API Security</option>
                  <option value="platform_config">Platform Config</option>
                  <option value="identity">Identity</option>
                  <option value="data_contracts">Data Contracts</option>
                  <option value="salesforce">Salesforce</option>
                  <option value="elastic">Elastic</option>
                  <option value="idp_platform">IDP Platform</option>
                </select>
                <small>All test suites in this harness must have the same domain.</small>
              </div>
              ...
              <div class="form-section">
                ...
                <div v-else class="selection-list">
                  <div
                    ...
                    :class="{ 'type-mismatch': form.domain && suite.domain !== form.domain }"
                  >
                    <label class="checkbox-label">
                      ...
                      <div class="option-info">
                        ...
                        <span class="option-meta">
                          ...
                          <span v-if="suite.domain" class="suite-type-badge"> • Domain: {{ suite.domain }}</span>
                        </span>
                      </div>
                    </label>
                  </div>
                  <div v-if="form.domain && filteredSuites.length === 0" class="empty-state">
                    <p>No test suites found with domain "{{ form.domain }}". Create a test suite with this domain first.</p>
                  </div>
                </div>
              </div>
...
import type { TestHarness } from '../../heimdall-framework/core/types';
