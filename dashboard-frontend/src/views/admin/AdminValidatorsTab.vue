<template>
  <div class="admin-validators-tab">
    <div class="section-header">
      ...
      <BaseButton label="Add Validator" :icon="Plus" @click="showAddValidatorModal = true" />
    </div>
    ...
    <div v-else-if="error" class="error-state">
      ...
      <BaseButton label="Retry" @click="loadValidators" />
    </div>
